...
async function main() {
    ...
    console.log("AE06 - U - Credential issuance -  User -\tStore identity wallet");
    AEWS.storeIdentityWallet(userEpicWallet, storagePath + "/test_data/AE02_User_Identity_Wallet.json")

    console.log("AE06 - E - Credential issuance -  Entity - \tStore identity wallet");
    AEWS.storeIdentityWallet(entityEpicWallet, storagePath + "/test_data/AE02_Entity_Identity_Wallet.json")

    console.log("AE06 - P - Credential issuance -  Provider -\tStore identity wallet");
