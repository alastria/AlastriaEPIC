...
async function main() {
    ...
    lconsole.log(logTxt,"U - Onboarding - User -\tCreate object and load identity");
    ...
    lconsole.log(logTxt,"E - Onboarding - Entity -\tCreate object and load identity");
    ...
    lconsole.log(logTxt,"P - Onboarding - Provider -\tCreate object and load identity");
    ...
    lconsole.log(logTxt,"U - Onboarding - User -\tCreate login derivation for Entity");
    ...
    lconsole.log(logTxt,"U - Onboarding - User -\tSend user login extPubK to Entity");
    ...
    lconsole.log(logTxt,"E - Onboarding - Entity -\tEntity receives login extPubK from User");        
    ...
    lconsole.log(logTxt,"U - Onboarding - User -\tSend user login derivation to Entity");
    commsD.SendTo("JohnDoe","AcmeDriving","loginDerivation",loginDerivation);

    lconsole.log(logTxt,"E - Onboarding - Entity -\tEntity receives login derivation from User");    
