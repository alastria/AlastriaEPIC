...
async function main() {
    ...
    lconsole.log(logTxt,"U - Credential presentation -  User -\tCreate object and load identity");
    ...
    lconsole.log(logTxt,"E - Credential presentation -  Entity -\tCreate object and load identity");
    ...
    lconsole.log(logTxt,"P - Credential presentation -  Provider -Create object and load identity");
    ...
    lconsole.log(logTxt,"P - Credential presentation -  Provider -Create presentation request (derivation)");
    ...
    lconsole.log(logTxt,"U - Credential presentation -  User -\tCreate presentation object");
    ...
    lconsole.log(logTxt,"U - Credential presentation -  User -\tRegister presentation in wallet");
    ...
    lconsole.log(logTxt,"U - Credential presentation -  User -\tGet presentation data for siganture");    
    subjectPublicKey = userEpicWallet.getPresentationExtendedPublicKey("Rent_a_K",presentationHash);
    
    lconsole.log(logTxt,"U - Credential presentation -  User -\tSign presentation");
    let presentationSignature = await userEpicWallet.signPresentation("Rent_a_K",presentationHash,presentation);
        
    lconsole.log(logTxt,"U - Credential presentation -  User -\tPrepare presentation data: credentials PubKs");
    ...
    lconsole.log(logTxt,"U - Credential presentation -  User -\tPrepare presentation data: credentials derivations");
    let cred_derivation_set = [cred1_der, cred2_der, cred3_der];

    lconsole.log(logTxt,"U - Credential presentation -  User -\tPrepare presentation data: identity PublicKey");
    ...
    lconsole.log(logTxt,"U - Credential presentation -  User -\tUser sends data to Service Provider 'Rent_a_K'");
    ...
    lconsole.log(logTxt,"P - Credential presentation -  Provider -'Rent_a_K' receives user data");
    ...
    if (providerEpicWallet.verifyPresentationSignature("JohnDoe",der,pres,sign)) {
        lconsole.log(logTxt,"P - Credential presentation -  Provider - CORRECT presentation signature");
      }
      else {
        lconsole.log(logTxt,"P - Credential presentation -  Provider - INVALID presentation signature");
      }
    ...
    if (providerEpicWallet.verifyChainOfTrust(user_identity,cred_derivations,cred_pub_ks)) {
        lconsole.log(logTxt,"P - Credential presentation -  Provider - Chain-of-Trust is CORRECT'");
        }
    else {
        lconsole.log(logTxt,"P - Credential presentation -  Provider - Chain-of-Trust is NOT VALID");        
    }
    ...
    lconsole.log(logTxt,"U - Credential presentation -  User -\tStore identity wallet");
    AEWS.storeIdentityWallet(userEpicWallet, storagePath + "/test_data/AE02_User_Identity_Wallet.json")

    lconsole.log(logTxt,"E - Credential presentation -  Entity - \tStore identity wallet");
    AEWS.storeIdentityWallet(entityEpicWallet, storagePath + "/test_data/AE02_Entity_Identity_Wallet.json")

    lconsole.log(logTxt,"P - Credential presentation -  Provider -\tStore identity wallet");
