...
async function main() {
    ...
    console.log(logTxt,"P - Create presentation request (derivation)");
    ...
    console.log(logTxt,"U - Create presentation object");
    ...
    console.log(logTxt,"U - Register presentation in wallet");
    ...
    console.log(logTxt,"U - Prepare presentation data: credentials derivations");
    let cred_derivation_set = [cred1_der, cred2_der, cred3_der];

    console.log(logTxt,"U - Prepare presentation data: identity PublicKey");
    ...
    console.log(logTxt,"U - User sends data to Service Provider 'Rent_a_K'");
    ...
    console.log(logTxt,"P - 'Rent_a_K' receives user data");
    ...
    if (providerEpicWallet.verifyPresentationSignature("JohnDoe",der,pres,sign)) {
        console.log(logTxt,"P - Presentation signature of CORRECT");
      }
      else {
        console.log(logTxt,"P - INVALID presentation signature");
      }
    ...
    if (providerEpicWallet.verifyChainOfTrust(user_identity,cred_derivations,cred_pub_ks)) {
        console.log(logTxt,"P - Chain-of-Trust is CORRECT'");
        }
    else {
        console.log(logTxt,"P - INVALID Chain-of-Trust");        
    }
